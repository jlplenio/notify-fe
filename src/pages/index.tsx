...
import { PlayCircleIcon, StopCircle, InfoIcon } from "lucide-react";
              ...
              <Tooltip delayDuration={0}>
                <TooltipTrigger asChild>
                  <button
                    type="button"
                    aria-label="Tips"
                    className="inline-flex items-center gap-1 rounded-full border border-green-300/60 bg-white/70 px-2 py-1 text-xs font-semibold text-green-900 shadow-sm transition hover:bg-white dark:border-green-800/60 dark:bg-green-900/40 dark:text-green-100"
                  >
                    <InfoIcon size={14} />
                    Checkout speed tips
                  </button>
                ...
                <TooltipContent
                  ...
                  align="center"
                  sideOffset={6}
                  className="max-w-[320px] p-3 text-sm leading-snug"
                >
                  <div className="space-y-1">
                    <ul className="list-disc space-y-1 pl-4">
                      <li>Ensure you are logged in to the NVIDIA site.</li>
                      <li>
                        Pre-save your credit card during checkout with a random item (no purchase needed).
                      </li>
                      <li>On mobile, try Google Pay or Apple Pay.</li>
                    </ul>
                  </div>
                </TooltipContent>
              </Tooltip>
